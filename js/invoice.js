$(document).ready(function () {
    ...
    $(document).on('change', '.order_item_price', function () {
        cal_final_total(count);
    });

    $(document).on('change', '.order_item_tax1_rate', function () {
        cal_final_total(count);
    });

    $(document).on('change', '.order_item_tax2_rate', function () {
        cal_final_total(count);
    });

    $(document).on('change', '.order_item_tax3_rate', function () {
        cal_final_total(count);
    });
